...
namespace {
bool eq(Kind kind, Type** a, size_t n, CompType* b) { return n == b->n && memcmp(a, b->v, n * sizeof(void*)) == 0; }
bool eq(CompType* a, CompType* b) { return eq(a->kind, a->v, a->n, b); }

size_t hash(Kind kind, Type** a, size_t n) {
	// TODO: hashCombine?
	return fnv(a, n * sizeof(void*));
}
size_t hash(CompType* a) { return hash(a->kind, a->v, a->n); }
...
Type* compType(Vec<Type*>& v) { return compType(v.data, v.n); }
